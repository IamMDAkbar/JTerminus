...
public class ToolBarPanel extends JPanel {
    ...
    public ToolBarPanel() {
        ...
        shellIcon = new JLabel("⌘");
        shellIcon.setFont(new Font("Segoe UI Emoji", Font.PLAIN, 18));
        ...
        clearButton = createToolButton("⌫", "Clear terminal");
    ...
    private void updateShellIcon() {
        ...
        switch (shell) {
            case "Linux" -> shellIcon.setText("🐧");
            case "CMD" -> shellIcon.setText("⊞");
            case "PowerShell" -> shellIcon.setText("⚡");
            case "RedHat" -> shellIcon.setText("🎩");
        }
    }
